        ...
        await camera.current?.startRecording({
          ...
          onRecordingFinished: async (video: VideoFile) => {
            try {
              ...
              formData.append('model', 'helmet-phone'); // or whatever model you want to pass
              ...
              // You can optionally use TTS or display response
              Alert.alert('Detection', json.commands.join(', '));
          
              setVideoPaths((prev) => [...prev, filePath]);
              setRecording(false);
            } catch (error) {
              console.error('Error uploading video:', error);
              Alert.alert('Error', 'Failed to send video to backend.');
              setRecording(false);
            }
          },          
